 ...
 */
package cn.wantedonline.puppy.httpserver.util.ch.qos.logback.core;
...
public class ContextBase implements Context, LifeCycle {
  ...
  // @CRACK 2013-8-6 使用统一的日志线程池
  private volatile ExecutorService executorService = ConcurrentUtil.getLogExecutor();
