 ...
 */
package cn.wantedonline.puppy.httpserver.util.ch.qos.logback.core.net;
...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    /** 连接SMTP服务器超时时间，单位ms */
    private int coTimeout = 60 * CoreConstants.MILLIS_IN_ONE_SECOND;
    /** 发送时间超时，单位ms */
    private int timeout = 60 * CoreConstants.MILLIS_IN_ONE_SECOND;
    ...
    protected void sendBuffer(CyclicBuffer<E> cb, E lastEventObject) {
        ...
        try {
            ...
            // @CRACK begin 2013-8-6 做了一些修改，通过日志发送的邮件采用html格式，并通过<tt>强制等宽，方便在各大邮箱查看
    ...
    /**
     * Set the location where a {@link javax.mail.Session} resource is located in JNDI. Default value is "java:comp/env/mail/Session".
     * 
     * @param jndiLocation
     * @since 1.0.6
     */
